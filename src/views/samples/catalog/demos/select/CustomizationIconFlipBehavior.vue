<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Select / Customization Icon Flip Behavior</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">flipIcon プロパティでセレクトが開いたときのアイコン反転動作を制御する例。</p>
      <ion-list>
          <ion-item>
            <ion-select
              class="always-flip"
