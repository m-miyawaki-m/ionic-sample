<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Accordion / Customization Expansion Styles</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">ion-accordion の展開スタイルをカスタマイズする例。CSS カスタムプロパティで見た目を変更できる。</p>
