  ...
  <ion-page>
    <ion-header>
        <ion-toolbar>
          ...
          <ion-title>Modal / Styling Theming</ion-title>
        </ion-toolbar>
      </ion-header>
      <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">CSS カスタムプロパティと Shadow Parts を使ったモーダルのスタイルカスタマイズ例。</p>
