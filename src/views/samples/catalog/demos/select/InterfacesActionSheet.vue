<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Select / Interfaces Action Sheet</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">interface="action-sheet" でアクションシート形式の選択 UI を使う例。</p>
      <ion-list>
          <ion-item>
