<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Datetime / Localization Hour Cycle</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">hourCycle プロパティで 12 時間制 / 24 時間制を切り替える例。</p>
