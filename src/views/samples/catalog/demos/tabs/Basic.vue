  ...
  <ion-tabs>
    <ion-tab tab="home">
      ...
      <ion-buttons slot="start"><ion-menu-button /></ion-buttons>
            <ion-title>Tabs / Basic</ion-title>
          </ion-toolbar>
        </ion-header>
        <ion-content>
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">タブナビゲーション（ion-tabs / ion-tab-bar）の基本的な使い方。タブの切り替えを確認できる。</p>
