<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Datetime / Title Showing Default Title</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">showDefaultTitle プロパティでデフォルトの日付タイトルを表示する例。</p>
