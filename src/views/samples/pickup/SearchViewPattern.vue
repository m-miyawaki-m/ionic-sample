  ...
  <ion-menu side="start" content-id="search-view-main">
      ...
      <ion-content>
        <ion-list>
          ...
          <ion-item button @click="closeMenu" router-link="/pattern/search-view" class="menu-active">
          ...
          <ion-item button @click="closeMenu" router-link="/pattern/inline-edit">
