<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Checkbox / Label Link</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">チェックボックスのラベル内にリンクを含める例。利用規約への同意 UI などに利用できる。</p>
