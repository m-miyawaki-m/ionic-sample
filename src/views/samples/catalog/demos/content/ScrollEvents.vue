<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Content / Scroll Events</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">ionScroll イベントを使ってスクロール位置の変化をリアルタイムに検知する例。</p>
