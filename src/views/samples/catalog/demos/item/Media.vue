<template>
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">画像やメディアを含む ion-item のレイアウト例。</p>
      <ion-item>
          <ion-avatar slot="start">
            <img alt="Silhouette of a person's head" src="@/assets/img/demos/avatar.svg" />
          </ion-avatar>
        ...
        <ion-item>
          <ion-thumbnail slot="start">
            <img alt="Silhouette of mountains" src="@/assets/img/demos/thumbnail.svg" />
          </ion-thumbnail>
