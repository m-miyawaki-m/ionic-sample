<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Select / Basic Responding To Interaction</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">ionChange イベントを使ってセレクトボックスの選択変化に応答する例。</p>
      <ion-list>
          <ion-item>
            <ion-select
              aria-label="Fruit"
