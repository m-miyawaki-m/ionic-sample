<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Datetime / Presentation Date</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">presentation="date" で日付のみを表示するカレンダー表示の例。</p>
