<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Datetime / Styling Datetime Header</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">CSS を使って datetime ヘッダー部分のスタイルをカスタマイズする例。</p>
