  ...
  <ion-page>
    <ion-header>
        <ion-toolbar>
          ...
          <ion-title>Modal / Sheet Background Content</ion-title>
        </ion-toolbar>
      </ion-header>
      <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">シートモーダル背後のコンテンツと連動する例。backdropBreakpoint の活用。</p>
