<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Accordion / Disable Individual</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">個別のアコーディオン項目を disabled にする例。特定の項目だけ操作不能にする方法。</p>
      <ion-accordion-group>
