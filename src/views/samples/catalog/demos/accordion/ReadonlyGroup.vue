<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Accordion / Readonly Group</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">アコーディオングループ全体を readonly にする例。開閉操作を受け付けなくなる。</p>
