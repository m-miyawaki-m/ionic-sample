<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Datetime / Title Customizing Title</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">titleSelectedDatesFormatter を使って選択済み日付のタイトル表示をカスタマイズする例。</p>
      <ion-datetime>
