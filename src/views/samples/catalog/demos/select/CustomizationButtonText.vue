<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Select / Customization Button Text</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">okText / cancelText プロパティで確認・キャンセルボタンのテキストを変更する例。</p>
      <ion-list>
          <ion-item>
