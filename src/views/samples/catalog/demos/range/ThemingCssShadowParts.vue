<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Range / Theming Css Shadow Parts</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">CSS Shadow Parts を使ったスライダーの詳細なスタイリング例。</p>
      <h2>Single Knob</h2>
        <ion-range
          id="range-single"
