<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Action Sheet / Inline Trigger</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">trigger 属性を使い、ボタンクリックでアクションシートを開くインラインパターン。</p>
