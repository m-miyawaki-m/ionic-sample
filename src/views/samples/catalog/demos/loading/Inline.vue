<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Loading / Inline</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">ion-loading をインラインコンポーネントとして使う例。isOpen でリアクティブに制御する。</p>
