<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Select / Start End Slots</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">start / end スロットを使ってセレクトの前後にアイコンやボタンを配置する例。</p>
      <ion-list>
          <ion-item>
