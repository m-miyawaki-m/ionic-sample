<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Avatar / Theming Css Properties</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">CSS カスタムプロパティを使ったアバターのスタイルカスタマイズ例。</p>
      <ion-avatar>
