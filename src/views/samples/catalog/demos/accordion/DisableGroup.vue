<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Accordion / Disable Group</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">アコーディオングループ全体を disabled にする例。グループ単位での無効化を確認できる。</p>
