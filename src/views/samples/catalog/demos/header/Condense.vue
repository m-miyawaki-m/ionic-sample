  ...
  <ion-page>
    <ion-header :translucent="true">
        <ion-toolbar>
          ...
          <ion-title>Header / Condense</ion-title>
        </ion-toolbar>
      </ion-header>
      <ion-content :fullscreen="true">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">collapse="condense" でスクロール時にヘッダーが小さくなるコンデンスヘッダーの例（iOS のみ）。</p>
        ...
        <div class="ion-padding">
          ...
          <img
            ...
            src="@/assets/img/demos/card-media.svg"
          />
          <p>
