<template>
  <ion-page>
    <ion-header><ion-toolbar>
      ...
      <ion-title>Select / Objects As Values Using Comparewith</ion-title>
    </ion-toolbar></ion-header>
    <ion-content class="ion-padding">
      <p style="color:var(--ion-color-medium);font-size:14px;margin:0 0 16px">compareWith プロパティでオブジェクト値の比較方法を定義する例。</p>
      <ion-list>
          <ion-item>
            <ion-select
              aria-label="Food"
